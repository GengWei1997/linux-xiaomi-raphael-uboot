...
"$SCRIPT_DIR/scripts/11-config-modem.sh"
"$SCRIPT_DIR/scripts/12-config-fstab.sh"
"$SCRIPT_DIR/scripts/13-create-users.sh"
"$SCRIPT_DIR/scripts/14-config-power.sh"
"$SCRIPT_DIR/scripts/15-config-power-key.sh"
"$SCRIPT_DIR/scripts/16-config-zram.sh"
"$SCRIPT_DIR/scripts/17-config-audio.sh"
"$SCRIPT_DIR/scripts/18-cleanup.sh"
"$SCRIPT_DIR/scripts/19-finalize.sh"
